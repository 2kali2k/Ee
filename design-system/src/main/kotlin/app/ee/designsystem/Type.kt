...
/**
 * Material 3 type scale. Defaults are already close to M3; we only tighten the
 * display/title sizes for the dense file-manager UI.
 */
val EeTypography = Typography(
